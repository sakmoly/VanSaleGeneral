                ...
                if (spinner_type.equals("Bank")) {
                        ...
                        if (!reference_date.getText().toString().isEmpty()) {
                            if (!received_amount.getText().toString().isEmpty()) {
                               ...
                               // Toast.makeText(this, "" + spinner_value, Toast.LENGTH_SHORT).show();
                                ...
                                db.addPayment(new Payment(creation_date.getText().toString()+" "+Utility.getCurrentTime(), payment_no.getText().toString(), spinner_value, received_amount.getText().toString(), customer_tv.getText().toString(), 0,reference_no.getText().toString(),reference_date.getText().toString(),paid_to.getText().toString(),Utility.getLoginUser(this)));
                    ...
                    if (!received_amount.getText().toString().isEmpty()) {
                      ...
                      //  Toast.makeText(this, "" + spinner_value, Toast.LENGTH_SHORT).show();
                        ...
                        db.addPayment(new Payment(creation_date.getText().toString()+" "+Utility.getCurrentTime(), payment_no.getText().toString(), spinner_value, received_amount.getText().toString(), customer_tv.getText().toString(), 0,"","",paid_to.getText().toString(),Utility.getLoginUser(this)));
                        db.updatePaymentDocNo(db.getPaymentDocNo() + 1);
