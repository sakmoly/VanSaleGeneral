...
public class SettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private CheckBox mCustomerAccessCheck, mOrderAccessCheck, mInvoiceAccessCheck, mPaymentAccessCheck, mTransferAccessCheck,mCustomerVisitCheck,mManageFreezerCheck;
    ...
    private int mCustomerAccessStatus = 0, mOrderAccessStatus = 0, mInvoiceAccessStatus = 0, mPaymentAccessStatus = 0, mTransferAccessStatus = 0,
            mCustomerVisitStatus=0,mManageFreezerStatus=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomerVisitCheck = (CheckBox) findViewById(R.id.customer_visit_access_check);
        mManageFreezerCheck = (CheckBox) findViewById(R.id.manage_freezer_check);
        ...
        if (!getSettings.isEmpty()) {
            ...
            if (getSettings.get(0).getCustomer_visit_access() == 1) {
                mCustomerVisitCheck.setChecked(true);
                mCustomerVisitStatus = 1;
            }
            if (getSettings.get(0).getManage_freezer() == 1) {
                mManageFreezerCheck.setChecked(true);
                mManageFreezerStatus = 1;
            }
        ...
        mCustomerVisitCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b) {
                    ...
                    mCustomerVisitStatus = 0;
                }
            }
        });
        mManageFreezerCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
...
//Menu for default settings update
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.UpdateDefaultSettings:
                //Utility.setToast(SettingActivity.this,"default").show();
                setDefault();
                break;
    ...
    private void setDefault()    {
        ...
        mTransferAccessCheck.setChecked(true);
        mInvoiceAccessCheck.setChecked(true);
        mManageFreezerCheck.setChecked(false);
        mCustomerVisitCheck.setChecked(false);
                                                                                ...
                                                                                if (!default_payment_mode.getText().toString().isEmpty()) {
                                                                                    if (!mSyncInterval.getText().toString().isEmpty()) {
                                                                                        ...
                                                                                        db.addSettings(new SettingsClass(
                                                                                                ...
                                                                                                mCustomerVisitStatus,
                                                                                                mManageFreezerStatus,
                                                                                        ...
                                                                                        Call<Authentication_Response> authentication_responseCall = userInterface.authentication(mApiUserName.getText().toString(), mApiPassword.getText().toString());
