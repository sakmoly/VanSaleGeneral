...
public class Payment {
    ...
    private String PAYMENT_CREATION,PAYMENT_DOC_NO,MODE_OF_PAYMENT,RECEIVED_AMOUNT,PAYMENT_CUSTOMER,PAYMENT_REFERENCE_NO,PAYMENT_REFERENCE_DATE,PAYMENT_PAID_TO,PAYMENT_OWNER;
    private Integer KEY_ID,PAYMENT_SYNC_STATUS;

    public Payment() {
    }

    public Payment(String PAYMENT_CREATION, String PAYMENT_DOC_NO, String MODE_OF_PAYMENT, String RECEIVED_AMOUNT, String PAYMENT_CUSTOMER, Integer PAYMENT_SYNC_STATUS,String PAYMENT_REFERENCE_NO,String PAYMENT_REFERENCE_DATE,String PAYMENT_PAID_TO,String PAYMENT_OWNER) {
