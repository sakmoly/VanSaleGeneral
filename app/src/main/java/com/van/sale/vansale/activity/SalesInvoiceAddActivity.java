...
public class SalesInvoiceAddActivity extends AppCompatActivity implements View.OnClickListener , GoogleApiClient.ConnectionCallbacks,
    ...
    private Boolean customer_visit_access;
    ...
    private View customer_visit_access_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //gpsloc=getLocation();
        ...
        customer_visit_access_layout=(View)findViewById(R.id.customer_visit_layout) ;
        customer_visit_access=((VanGlobals)getApplicationContext()).getCustomer_visit_access();
        if(!customer_visit_access)
            customer_visit_access_layout.setVisibility(View.INVISIBLE);
