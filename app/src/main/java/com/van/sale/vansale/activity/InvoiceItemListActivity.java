...
public class InvoiceItemListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private View asset_search_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asset_search_layout=(View)findViewById(R.id.assetSearch);
        isAssetRequired=((VanGlobals)getApplicationContext()).getIsasset_reqd();
        customer_visit_access=((VanGlobals)getApplicationContext()).getCustomer_visit_access();


        if(!isAssetRequired)
            asset_search_layout.setVisibility(View.INVISIBLE);
