...
public class PaymentRaw_TokenResponse {
    ...
    private double allocate_payment_amount;
    ...
    public Double getAllocate_payment_amount() {
        return allocate_payment_amount;
    }

    public void setAllocate_payment_amount(Double allocate_payment_amount) {
